...
export namespace TreeConstructor {
  ...
  interface Node<
    T extends NodeTypes.AnyNodeType,
    C extends NodeContents.AnyNodeContent
  > {
    nodeType: T;
    content: C;
  }
  ...
  interface DoctypeAttribute {
    startWrapper?: Tokenizer.Token<
      Tokenizer.TokenTypes.DoctypeAttributeWrapperStart
    >;
    value: Tokenizer.Token<Tokenizer.TokenTypes.DoctypeAttribute>;
    endWrapper?: Tokenizer.Token<
      Tokenizer.TokenTypes.DoctypeAttributeWrapperEnd
    >;
  }
  ...
  interface TagAttribute {
    ...
    startWrapper?: Tokenizer.Token<
      Tokenizer.TokenTypes.AttributeValueWrapperStart
    >;
